		...
		<div id="header" style="height:58px;">
			...
			<div class="nav_area">
				...
				<c:if test="${useDirGroup && isAdmin}">
					...
					<!--
					<li class="menu_more" onclick="toggle_hide_memu()"></li>
					-->
				</ul>
				<!-- //normal user menu -->
...
<div class="bpa_org_gnb">
		<ul id="_gnb_menus" style="margin-left:100px;">
			<li id="menuPal"><a href="#">조직도 조회</a></li>
            <li id="menuBpm" class="on"><a href="#">조직도 관리</a></li>
			<li id="menuSummary"><a href="#">그룹 관리</a></li>
	</ul>
</div>            
